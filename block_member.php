...
<title>رسالة إدارية :: تم حظرك</title>
...
if(isset($_SESSION['id_members']) and $group_num === "5"){}else{header("location:index.php");}
?>
<div class="row" id="wrapper">
<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">

<div class="alert alert-danger">
	لقد قامت الأدارة بحظر عضويتك 
	<br>
	يبدو انك قد خالفت احد الشروط في معاهدة الموقع :: إذا لم تخالف الشروط التالية يرجة التواصل مع الأدارة 
	</div>
...
<?php
				...
				include("include/config.php");
				mysqli_query($mysqli,"SET NAMES 'utf8'");
				$query_keyinformation_print = "SELECT * FROM `text` WHERE id = \"4\" ";
				$result_keyinformation_print = mysqli_query($mysqli,$query_keyinformation_print);
				$print_value = mysqli_fetch_array($result_keyinformation_print);
