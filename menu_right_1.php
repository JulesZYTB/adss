<div class="col-xs-12  col-sm-3 col-md-3 col-lg-3 " id="firstDiv">
   ...
   <?php if(empty($username) || (!empty($username) and $username === "السيارات")){ ?>
...
<?php  } ?>
    ...
    <?php if(empty($username) || (!empty($username) and $username === "الأجهزة")){ ?>
...
<hr>
 ...
 <?php if(empty($username) || (!empty($username) and $username === "عام")){ ?>
 <ul class="nav nav-tabs">
...
<div class="clear"></div>
 ...
 ?>
  ...
  <?php if(empty($username) || (!empty($username) and $username === "العقارات")){ ?>
 <ul class="nav nav-tabs">
...
<!--<h3><a href="<?php echo $url_hraj; ?>">منتدى السيارات </a></h3>-->
    ...
    <?php if(!empty($username)){ ?>
			...
			<form class="form-inline" method="get" action="<?php echo $url_hraj; ?>search.php">
 			...
 			<input type="search" name="key" class="form-control " placeholder="ابحث عن سلعه في <?php echo $username; ?> ..." id="autocomplete" style="width: 100%;">
<input type="hidden" name="<?php if($type_tag === "رئيسي"){echo "ads_tags_R";}else{
						  if($type_tag === "فرعي"){echo "ads_tags_F";}else{
						  if($type_tag === "فرعي الفرعي"){echo "ads_tags_FF";}else{
						  if(!empty($username)){echo "type_ads_other_final";}  
