...
<br>
	...
	include("include/config.php");			
	mysqli_query($mysqli,"SET NAMES 'utf8'");
  	$query_ads = "SELECT * FROM `ads` WHERE close_ads = \"0\" and type_ads_or = \"2\" and fixed_home = \"1\" ORDER BY Last_updated_Ad DESC";
	$query_ads_ex = mysqli_query($mysqli,$query_ads);
 ...
 */
 $fixed_query_php = "and type_ads_or = \"2\" and fixed_home = \"0\" and fixed_tub = \"0\" and fixed_sec = \"0\" and fixed_sec2 = \"0\" and fixed_sec3 = \"0\"";
 mysqli_query($mysqli,"SET NAMES 'utf8'");
