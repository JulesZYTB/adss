...
<title><?php echo $namewebsite; ?> <?php echo $ads_city_name; ?></title>
...
<br><br>
	...
	include("../gallery2.php"); // معرض الصور المصغر
...
<button class="btn btn-primary active" onclick="location.href='<?php echo $url_hraj ?>city/<?php echo $tag_id; ?>/<?php echo $ads_city_name; ?>

<?php if(empty($username)){}else{echo "/$username";} ?>'"><i class="fa fa-globe"></i></button>

		  <button class="btn btn-primary " onclick="location.href='<?php echo $url_hraj ?>citys/<?php echo $tag_id; ?>/<?php echo $ads_city_name; ?>
...
<br>
	...
	$query_ads = "SELECT * FROM `ads` WHERE close_ads = \"0\" $query_ads_city_search $query_ads_city_search2 ORDER BY Last_updated_Ad DESC";
 ...
 */
 ...
 $fixed_query_php = "$query_ads_city_search $query_ads_city_search2";
