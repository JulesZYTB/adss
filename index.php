...
<div class="row" id="wrapper">
   ...
   <?php
   include("menu_right_1_index0.php"); //  استدعاء ملف القائمة الجانبية
   ?>
...
<a href="add.php" class="btn btn-success btn-lg "><i class="fa fa-plus "></i>  
أضف إعلانك في إعلانات السعودية</a>
...
/*	$pg = $_GET['page'];
	...
	$pg++;
 if ($page <= $lastpage - 1) {
 	   echo  "<br></br><a href=\"$targetpage?page=$pg\" class='btn  btn-success form-control  '>شاهد المزيد</a>";     
