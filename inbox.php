...
<title>الرسائل الواردة - <?php echo $namewebsite; ?></title> 
...
<div class="row">
	...
	";
			...
			set futurest = \"delete\" where id IN ($impid_pm) and future = \"$id\" ";
    ...
    <?php
				...
				where future = \"$id\" and futurest = \"\" order by id DESC";
				...
				$type = $pm_inf[type];
				$Bonds = $pm_inf[Bonds];
				$id_message_dif = $pm_inf[id];
				
				
				if($type === "message"){
					$href_pm = "readpm.php?id=$id#$id_message_dif";
					}
					
				if($type === "post"){
					$href_pm = "readpm.php?id=$Bonds#$id_message_dif";
					}
                ...
                <a href="<?php echo $href_pm; ?>">
                <img src="templates/default/images2/<?php echo $status; ?>.png" alt="">
	...
	<div class="col-xs-12  col-sm-4 col-md-3 col-lg-3">	
		...
		<ul>
		  ...
		  <li><a href="outbox.php">الانتقال للرسائل المرسلة</a></li>
		</ul>
