...
$mobile = "966557845545";							//رقم الجوال (إسم المستخدم) في موبايلي
$password = "5545";							//كلمة المرور في موبايلي

$sender = "ALHARAMAIN";					//اسم المرسل الذي سيظهر عند ارسال الرساله، ويتم تشفيره إلى  بشكل تلقائي إلى نوع التشفير (urlencode)

$numbers = $phone_pass_member;							//يجب كتابة الرقم بالصيغة الدولية مثل 96650555555 وعند الإرسال إلى أكثر من رقم يجب وضع الفاصلة (,) وهي التي عند حرف الواو بين كل رقمين 
...
$msg = "
بيانات تسجيلك في موقع $namewebsite هي كالتالي:

أسم المستخدم :
$username_pass_member
الرقم السري: 
