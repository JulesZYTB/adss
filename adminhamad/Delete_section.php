...
<title>حذف الأقسام - لوحة التحكم</title>
...
<div class="wrap">
	<div id="header">
		...
		<div id="main">
		  <div class="full_w">
		    <div class="h_title">حذف الأقسام</div>
            <?php
				$id_acc = $_GET['id'];
			...
			$query_add_bank = "SELECT * FROM `section` WHERE id = \"$id_acc\"";
			...
			$unicode_arabic = mysqli_query($mysqli,"SET NAMES 'utf8'");
			$query_delet_bank = "DELETE FROM `section` WHERE `id` = \"$id_acc\" LIMIT 1;";
			...
			if($execution_query_delet_bank){
						echo "
						<div class=\"n_ok\"><p>
						تم حذف القسم بنجاح جاري تحويلك لصفحة عرض الأقسام 
						</p></div>
						";
						...
						echo "
						<div class=\"n_error\"><p>
						للأسف لا يمكن حذف القسم حاول في وقت لاحق
						</p></div>
						";
					}
								...
								echo "
						<div class=\"n_error\"><p>
						للأسف القسم الذي تريد حذفه غير موجود حاول في وقت لاحق
						</p></div>
						";
