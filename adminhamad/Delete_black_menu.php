...
<title>حذف من القائمة السوداء - لوحة التحكم</title>
...
<div class="wrap">
	<div id="header">
		...
		<div id="main">
		  <div class="full_w">
		    <div class="h_title">حذف من القائمة السوداء</div>
            <?php
				$id_acc = $_GET['id'];
			...
			$query_add_bank = "SELECT * FROM `black_menu` WHERE id = \"$id_acc\"";
			...
			$unicode_arabic = mysqli_query($mysqli,"SET NAMES 'utf8'");
			$query_delet_bank = "DELETE FROM `black_menu` WHERE `id` = \"$id_acc\" LIMIT 1;";
			...
			if($execution_query_delet_bank){
						...
						";
								...
								echo "
						<div class=\"n_error\"><p>
						للأسف لا يمكن الحذف في الوقت الحالي
						</p></div>
						";
