...
<title>إضافة للقائمة السوداء - لوحة التحكم</title>
...
<div class="wrap">
	<div id="header">
		...
		<div id="main">
		  <div class="full_w">
		    <div class="h_title">إضافة للقائمة السوداء</div>
            <?php
			...
			$query_add_bank = "	INSERT INTO `black_menu`(`id`, `text`) VALUES (NULL, \"$text\");";
			$execution_query_add_bank = mysqli_query($mysqli,$query_add_bank);
			if($execution_query_add_bank){
						echo "
						<div class=\"n_ok\"><p>
						تم الإضافة بنجاح للقائمة السوداء
						</p></div>
						";
						
						echo "<meta http-equiv=\"refresh\" content=\"2;URL=view_black.php\">";
				}else{
						echo "
						<div class=\"n_error\"><p>
						للأسف لم تتم الأضافة
						</p></div>
						";
					}
			...
			?>
				<form action="" method="post">
					...
					<div class="element">
						<label for="name">رقم الحساب أو الجوال <span class="red">(مطلوب)</span></label>
					...
					<div class="entry">
					 <input type="submit" class="add_Account" name="ADD_Account" value="إضافة" />
					</div>
