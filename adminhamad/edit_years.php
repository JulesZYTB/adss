		...
		<div id="main">
		  <div class="full_w">
			...
			if($execution_query_add_bank){
						...
						echo "
						<div class=\"n_error\"><p>
						للأسف لم تتم تعديل السنة بنجاح 
						</p></div>
						";
					}
			...
			$query_keyinformation_print = "SELECT * FROM `years` WHERE id = \"$id_se\" ";
			...
			?>
				<form action="" method="post">
					...
					<div class="entry">
					 <input type="submit" class="add_Account" name="ADD_Account" value="تعديل السنة" />
					</div>
