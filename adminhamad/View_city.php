...
<title>عرض المدن - لوحة التحكم</title>
...
<div class="full_w">
				<div class="h_title">عرض المدن - التعديل - الحذف </div>
				<h2>عرض المدن</h2>
				<p>
                يتم هنا تعديل المدن و حذفها
                </p>
				...
				$view_query_bank_accounts = "SELECT * FROM `cities` ORDER BY text";
    ...
    */
    ...
    $targetpage = "View_city.php";     //your file name  (the name of this file)
    ...
    /* Get data. */
    $sql = "SELECT * FROM cities $search_message_query LIMIT $start, $limit";
    ...
    */
	...
	?>
        ...
        ?>
							...
							<td>
					<a onClick="return confirm('هل أنت متأكد من رغبتك في حذف المدينة ؟')" 
                    href="Delete_city.php?id=<?php echo $row[id] ?>" class="table-icon delete" title="حذف"></a>
							</td>
						</tr>
