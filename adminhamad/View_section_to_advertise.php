...
<title>عرض الأقسام عن - لوحة التحكم</title>
...
<div class="full_w">
				<div class="h_title">عرض الأقسام عن حذف و تعديل و عرض</div>
				<h2>عرض الأقسام</h2>
				<p>
                </p>
				...
				$view_query_bank_accounts = "SELECT * FROM `sectionoadvertise` ORDER BY id";
              ...
              <?php
    $tbl_name="sectionoadvertise";        //my  table name
    ...
    */
    ...
    $targetpage = "View_section_to_advertise.php";     //your file name  (the name of this file)
    ...
    /* Get data. */
    $sql = "SELECT * FROM sectionoadvertise order by id DESC $search_message_query LIMIT $start, $limit";
    ...
    */
	...
	?>
        ...
        ?>
							...
							<td><a href="edit_section_to_advertise.php?id=<?php echo $row[id] ?>">
							<?php echo $row[title] ?></a></td>
							<td>
					<a onClick="return confirm('هل انت متاكد من رغتك في الحذف ؟')" 
                    href="Delete_section_to_advertise.php?id=<?php echo $row[id] ?>" class="table-icon delete" title="حذف"></a>
							</td>
						</tr>
...
<?=$pagination?>-->
                ...
                لا يوجد اقسام ليتم عرضها ( هذه الأقسام الخاصة بغرض الأضافة )
                </p></div>
                <?php
					}
