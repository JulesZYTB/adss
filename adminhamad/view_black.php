...
<title>عرض القائمة السوداء - لوحة التحكم</title>
...
<div class="full_w">
				<div class="h_title">عرض القائمة السوداء - الحذف </div>
				<h2>عرض القائمة السوداء</h2>
				<p>
                يتم هنا عرض القائمة السوداء
                </p>
				...
				$view_query_bank_accounts = "SELECT * FROM `black_menu` ORDER BY text";
				...
				?>
					...
					<thead>
						<tr>
							<th scope="col">ID</th>
							<th scope="col">رقم الجوال او رقم الحساب</th>
              ...
              <?php
    $tbl_name="black_menu";        //my  table name
    ...
    */
    ...
    $targetpage = "View_year.php";     //your file name  (the name of this file)
    ...
    /* Get data. */
    $sql = "SELECT * FROM black_menu order by text DESC $search_message_query LIMIT $start, $limit";
    ...
    */
	...
	?>
        ...
        ?>
							...
							<td>
					<a onClick="return confirm('هل أنت متأكد من رغبتك في حذف العنصر ؟')" 
                    href="Delete_black_menu.php?id=<?php echo $row[id] ?>" class="table-icon delete" title="حذف"></a>
							</td>
						</tr>
...
<?=$pagination?>
            ...
            لا يوجد عناصر في القائمة السوداء لعرضها
                </p></div>
                <?php
					}
