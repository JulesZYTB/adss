...
<title>إضافة مدينة - لوحة التحكم</title>
...
<div class="wrap">
	<div id="header">
		...
		<div id="main">
		  <div class="full_w">
		    <div class="h_title">إضافة مدينة</div>
            <?php
			...
			$query_add_bank = "	INSERT INTO `cities`(`id`, `text`) VALUES (NULL, \"$text\");";
			...
			if($execution_query_add_bank){
						...
						echo "
						<div class=\"n_error\"><p>
						للأسف لم تتم إضافة المدينة بنجاح 
						</p></div>
						";
					}
			...
			?>
				<form action="" method="post">
					...
					<div class="element">
						<label for="name">اسم المدينة <span class="red">(مطلوب)</span></label>
					...
					<div class="entry">
					 <input type="submit" class="add_Account" name="ADD_Account" value="إضافة المدينة" />
					</div>
