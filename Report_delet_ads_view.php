...
<title>قائمة الأعلانات المحذوفة - الأسباب - <?php echo $namewebsite; ?></title> 
...
<div class="row">
	...
	<div class="col-xs-12  col-sm-8 col-md-9 col-lg-9 ">
		...
		<h3>قائمة الأعلانات المحذوفة</h3>
	...
	";
			...
			$query_pm_inbox_delete = "DELETE FROM `reasons_delete_ads` WHERE id IN ($impid_pm)";
    ...
    <?php
				...
				mysqli_query($mysqli,"SET NAMES 'utf8'");
				$query_number_pm_inbox = "SELECT * FROM `reasons_delete_ads` order by id DESC";
			...
			$id_user_m_ad02 =  $Data_member_m_ad02[id];	 
                ...
                تم بحذف الأعلان رقم : <?php echo $id_ads_del; ?> [
                 <a href="ads/<?php echo $id_ads_del; ?>">الأنتقال للأعلان </a>
                ]</td><td> 
               ...
               <td><?php echo $reson; ?></td>
					...
					?>
                    <div class="alert alert-info">لا يتوفر عناصر في قائمة الأعلانات المحذوفة</div>
					<?php
						}
					?>
