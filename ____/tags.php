...
<a href="<?php echo $fixed_htaccess; ?>add.php" class="btn btn-success btn-lg "> <i class="fa fa-plus "></i> أضف إعلانك معنا</a>
		  ...
		  <button class="btn btn-primary" onclick="location.href='<?php echo $url_hraj; ?>__/<?php echo $username; ?>'"><i class="fa fa-globe"></i></button>
		  <button class="btn btn-primary active" onclick="location.href='<?php echo $url_hraj; ?>____/<?php echo $username; ?>'"> <i class="fa fa-camera-retro  "></i> </button>
		</div>
...
<br>
	...
	include("../include/config.php");			
	mysqli_query($mysqli,"SET NAMES 'utf8'");
	$query_ads = "SELECT * FROM `ads` WHERE close_ads = \"0\" and type_ads_other_final = \"$username\" and image_link != \"\" ORDER BY Last_updated_Ad DESC";
 ...
 */
 $fixed_query_php = "and type_ads_other_final = \"$username\" and fixed_tub = \"0\" and image_link != \"\"";
 mysqli_query($mysqli,"SET NAMES 'utf8'");
